import { pgTable, text, timestamp, integer, boolean, uuid, serial } from 'drizzle-orm/pg-core';
...
export const vendorOrders = pgTable('vendor_orders', {
  ...
  payoutPaidByAdminId: uuid('payout_paid_by_admin_id').references(() => users.id),
